...
function handleSortChange(event) {
    ...
    if (selectedOption === "release-asc") {
        sortMoviesByReleaseDate("asc");
    } else if (selectedOption === "release-desc") {
        sortMoviesByReleaseDate("desc");
...
function sortMoviesByReleaseDate(order) {
...
function sortMoviesByTitle(order) {
    const sortedMovies = [...movies].sort((a, b) => {
